  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Pop - Where your prompts transform into thrilling stories, crafted by AI with the coherence and structure of a novella."
        />
      </Head>
      ...
      <Stack minH={'100vh'} direction={{ base: 'column', md: 'row' }}>
        <Flex p={8} flex={1} align={'center'} justify={'center'}>
          <Stack position="relative" spacing={6} w={'full'} maxW={'lg'}>
            ...
            <Text fontSize={{ base: 'md', lg: 'lg' }} color={'gray.500'}>
              {`Welcome to Pop - Where your prompts transform into thrilling stories, crafted by AI with the coherence and structure of a novella.`}
            </Text>
        ...
        <Flex position="relative" flex={1}>
          <Image
            src={
              'https://images.unsplash.com/photo-1620712943543-bcc4688e7485?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxBSSUyQ3N0b3J5dGVsbGluZ3xlbnwwfHx8fDE2ODg2ODUxNTV8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt={'Login Image'}
            objectFit={'cover'}
          />
